...
const NotificationSystem: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Floating Reminder Cards - Left Side */}
      {notifications
        ...
        .map((notification, index) => (
          <div
            key={notification.id}
            className="fixed bottom-24 left-4 bg-blue-500 text-white rounded-xl p-4 shadow-2xl max-w-sm animate-slideInLeft z-40"
                ...
                <div className="flex space-x-2">
                  {notification.action && (
                    <button
                      ...
                      className="bg-white text-blue-600 text-xs font-semibold py-1.5 px-3 rounded-md hover:bg-gray-100 transition-colors"
                    >
                      {notification.action.label}
                    </button>
                  )}
                  <button
                    onClick={() => markAsRead(notification.id)}
                    className="text-white text-xs py-1.5 px-3 border border-white rounded-md hover:bg-white hover:text-blue-600 transition-colors"
                  >
                    Dismiss
                  </button>
                </div>
