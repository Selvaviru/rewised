...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="bg-gradient-to-br from-blue-50 via-white to-blue-50 min-h-screen flex items-center overflow-hidden relative">
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fadeInLeft">
            ...
            <div className="flex items-center space-x-4 mb-8">
              <div className="bg-gradient-to-br from-blue-700 to-blue-800 p-3 rounded-full shadow-lg">
                <img 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 hover:scale-105 hover:shadow-lg btn-interactive"
              >
          ...
          <div className="space-y-6 animate-fadeInRight">
            {/* Consult a CA Card */}
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-blue-100 hover-lift transition-all duration-300">
              ...
              <button
                onClick={() => openWhatsApp('Hi, I would like to consult with a CA. Please guide me through the process and share the consultation fees.')}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 hover:scale-105 hover:shadow-lg btn-interactive"
              >
                <MessageCircle className="w-5 h-5" />
                <span>Consult a CA</span>
              </button>
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-20 animate-fadeInUp" style={{animationDelay: '1s'}}>
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-blue-100" style={{animationDelay: '1.1s'}}>
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-blue-100" style={{animationDelay: '1.2s'}}>
            <div className="bg-blue-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center hover-scale">
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-blue-100" style={{animationDelay: '1.3s'}}>
            <div className="bg-blue-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center hover-scale">
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-blue-100" style={{animationDelay: '1.4s'}}>
            <div className="bg-blue-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center hover-scale">
