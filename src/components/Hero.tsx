...
import { MessageCircle, FileText, Calculator, TrendingUp, Users, Award, Clock } from 'lucide-react';
...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="bg-gradient-to-br from-gray-50 via-white to-gray-50 min-h-screen flex items-center overflow-hidden relative">
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fadeInLeft">
            ...
            <div className="flex items-center space-x-4 mb-8">
              <div className="bg-gradient-to-br from-gray-700 to-gray-800 p-3 rounded-full shadow-lg">
                <img 
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800 hover:text-gray-600 transition-colors duration-300">TAXTIC</h1>
            ...
            <div className="space-y-4">
              <h2 className="text-5xl md:text-6xl font-bold leading-tight text-center">
                <span className="block text-gray-600 gradient-animate bg-clip-text text-transparent">INDIA'S #1</span>
              ...
              <p className="text-xl md:text-2xl text-gray-700 font-medium max-w-2xl text-center mx-auto">
                <span className="text-gray-600 font-bold">File ITR, GST Returns & Business Registration</span> with India's Leading Tax Experts
              </p>
              
              <p className="text-lg text-gray-600 max-w-2xl text-center mx-auto">
                Over <span className="font-bold text-gray-600">1000+ satisfied customers</span> trust TAXTIC for all their tax and compliance needs
              </p>
            </div>
            ...
            <div className="flex justify-center space-x-8 py-6">
              ...
              <div className="text-left hover-scale transition-all duration-300" style={{animationDelay: '0.2s'}}>
                <div className="text-3xl font-bold text-gray-600">24/7</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 hover:scale-105 hover:shadow-lg btn-interactive"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              <button
                onClick={openPhone}
                className="flex items-center space-x-2 text-gray-700 hover:text-gray-600 transition-all duration-300 hover:scale-105"
              >
          ...
          <div className="space-y-6 animate-fadeInRight">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover-lift transition-all duration-300">
              ...
              <div className="text-center mb-4">
                <span className="text-lg font-bold text-gray-600">₹4,000 - ₹10,000</span>
                <p className="text-sm text-gray-500">Consultation fees based on complexity</p>
              </div>
              <button
                onClick={() => openWhatsApp('Hi, I would like to consult with a CA. Please guide me through the process and share the consultation fees.')}
                className="w-full bg-gray-600 hover:bg-gray-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 hover:scale-105 hover:shadow-lg btn-interactive"
              >
                <MessageCircle className="w-5 h-5" />
                <span>Consult a CA</span>
              </button>
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-20 animate-fadeInUp" style={{animationDelay: '1s'}}>
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-gray-100" style={{animationDelay: '1.1s'}}>
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-gray-100" style={{animationDelay: '1.2s'}}>
            <div className="bg-gray-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center hover-scale">
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-gray-100" style={{animationDelay: '1.3s'}}>
            <div className="bg-gray-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center hover-scale">
          ...
          <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-xl hover-lift transition-all duration-300 animate-fadeInUp border border-gray-100" style={{animationDelay: '1.4s'}}>
            <div className="bg-gray-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center hover-scale">
