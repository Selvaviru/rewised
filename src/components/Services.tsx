...
const Services: React.FC = () => {
  ...
  const services = [
    {
      icon: <Calculator className="w-12 h-12 text-gray-600" />,
    ...
    {
      icon: <Receipt className="w-12 h-12 text-gray-600" />,
      title: 'GST Services',
    ...
    {
      icon: <Gavel className="w-12 h-12 text-gray-600" />,
    ...
    {
      icon: <UserCheck className="w-12 h-12 text-gray-600" />,
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20 animate-fadeInUp" style={{animationDelay: '0.2s'}}>
          {services.map((service, index) => (
            <div
              id={service.id}
              key={index}
              className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-t-4 border-gray-600 hover-lift animate-fadeInUp"
            ...
            >
              ...
              <div className="text-center mb-4">
                <span className="text-lg font-bold text-gray-600">{service.price}</span>
              </div>
...
Thank you!`;
                ...
                className="w-full bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg btn-interactive"
              >
                Get Started
              </button>
            </div>
        ...
        {/* Why Choose Us */}
        <div className="bg-white rounded-2xl p-12 shadow-lg hover-lift animate-fadeInUp border border-gray-100" style={{animationDelay: '0.4s'}}>
        ...
        <div className="mt-20 animate-fadeInUp" style={{animationDelay: '0.6s'}}>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center animate-fadeInUp hover-scale" style={{animationDelay: '0.7s'}}>
              <div className="bg-gray-600 text-white rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center text-2xl font-bold hover-scale animate-bounce-custom">
                1
              </div>
            ...
            <div className="text-center animate-fadeInUp hover-scale" style={{animationDelay: '0.8s'}}>
              <div className="bg-gray-600 text-white rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center text-2xl font-bold hover-scale animate-bounce-custom" style={{animationDelay: '0.2s'}}>
                2
              </div>
            ...
            <div className="text-center animate-fadeInUp hover-scale" style={{animationDelay: '0.9s'}}>
              <div className="bg-gray-600 text-white rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center text-2xl font-bold hover-scale animate-bounce-custom" style={{animationDelay: '0.4s'}}>
                3
              </div>
            ...
            <div className="text-center animate-fadeInUp hover-scale" style={{animationDelay: '1s'}}>
              <div className="bg-gray-600 text-white rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center text-2xl font-bold hover-scale animate-bounce-custom" style={{animationDelay: '0.6s'}}>
                4
              </div>
