        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16 animate-fadeInUp" style={{animationDelay: '0.2s'}}>
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white p-8 rounded-2xl hover-lift transition-all duration-300 animate-fadeInRight gradient-animate">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-xl font-bold mb-3 text-blue-100">Mission</h4>
              ...
              <div>
                <h4 className="text-xl font-bold mb-3 text-blue-100">Vision</h4>
                <p className="text-blue-50">
        ...
        <div className="mb-16 animate-fadeInUp" style={{animationDelay: '0.8s'}}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover-lift transition-all duration-300 animate-fadeInUp" style={{animationDelay: '1.2s'}}>
              <div className="bg-orange-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center hover-scale">
        ...
        <div className="bg-gray-50 rounded-2xl p-12 hover-lift transition-all duration-300 animate-fadeInUp" style={{animationDelay: '1.3s'}}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center animate-fadeInUp hover-scale" style={{animationDelay: '1.5s'}}>
              <div className="bg-green-100 rounded-full p-6 w-20 h-20 mx-auto mb-4 flex items-center justify-center hover-scale animate-pulse-custom" style={{animationDelay: '0.5s'}}>
            ...
            <div className="text-center animate-fadeInUp hover-scale" style={{animationDelay: '1.6s'}}>
              <div className="bg-purple-100 rounded-full p-6 w-20 h-20 mx-auto mb-4 flex items-center justify-center hover-scale animate-pulse-custom" style={{animationDelay: '1s'}}>
            ...
            <div className="text-center animate-fadeInUp hover-scale" style={{animationDelay: '1.7s'}}>
              <div className="bg-orange-100 rounded-full p-6 w-20 h-20 mx-auto mb-4 flex items-center justify-center hover-scale animate-pulse-custom" style={{animationDelay: '1.5s'}}>
